...
class GLProvider:
    ...
    def generateQueries(
        ...
        Args:
            ...
            from_date: Optional start date in YYYY-MM-DD format (not used in query generation)
            to_date: Optional end date in YYYY-MM-DD format (not used in query generation)
        ...
        if provider:
            # Note: date parameters are accepted but not passed to generate_queries
            # They are used during search execution, not query generation
