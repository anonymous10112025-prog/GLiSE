...
class QueryGeneration:
    ...
    def __init__(
        ...
        # Optional date range for the query generation (ISO date strings, e.g. '2025-11-01')
        # These are optional and may be None. They are stored in info.json when saved.
    ...
    def load(instance_id: str, storage_root: str = "storage") -> "QueryGeneration":
        ...
        # Load optional date range if present
        instance.from_date = info_data.get("from_date")
        instance.to_date = info_data.get("to_date")
